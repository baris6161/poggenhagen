          ...
          <div className="card-surface neon-border-glow p-6 md:p-10 max-w-3xl mx-auto">
            ...
            <div className="flex items-center justify-between gap-4 text-center">
              <div className="flex-1">
                <p className="font-display text-3xl md:text-5xl font-bold text-foreground">{match.homeTeam.split(" ").pop()}</p>
              ...
              <div className="flex-1">
                <p className="font-display text-3xl md:text-5xl font-bold text-foreground">{match.awayTeam.split(" ").pop()}</p>

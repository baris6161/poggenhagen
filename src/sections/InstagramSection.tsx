          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl w-full">
            {images.map((imageUrl, i) => (
              <motion.a
                ...
                className="card-surface aspect-square overflow-hidden relative group cursor-pointer w-full"
              >
                ...
                <div className="absolute inset-0 border border-primary/0 group-hover:border-primary/30 transition-colors duration-300 pointer-events-none z-10" />
              </motion.a>
            ))}
          </div>
        </div>
